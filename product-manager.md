...
> 想象这样一个场景：你在一个大的产品线中，包括你在内，有5个产品经理同时负责该项目，不同的需求方给你们提了需求，请问你们怎么记录和维护这些需求呢？各自为战吗？
>
> 答案：使用需求池统一管理

#### 关于需求池的几个注意事项

1. 需求池在每个企业都可能是不同的，并没有统一的标准
2. 需求池由哪些部门维护，在不同的企业，可能也不一样
3. 通常来说，需求池会包含这样几个模块：需求、干系人、时间节点、优先级

### 功能清单

功能清单是产品功能的列表集合，一般包括功能模块、子模块、功能点、优先级和功能描述等信息。

#### 关于功能清单的几个注意事项

1. 功能清单在每个企业都可能是不同的，并没有统一的标准
2. 功能清单不一定所有企业都有，但如果有，基本都由产品部门维护
3. 内容的优先级由需求方定

### 流程图

> 想象这样一个场景：你现在负责的某个产品，所涉及的业务逻辑很复杂，你涉及的产品页面比较多，跟项目组成员讲解的时候，他们能看得懂单个页面，但理解不了整体的业务结构和流程走向。请问怎么办？
>
> 答案：制作业务流程图

#### 流程图的作用

1. 通过梳理流程，让产品经理在设计产品时，思路更加清晰
2. 产品经理在跟项目组成员介绍时，通过流程图，可以让大家更好地理解业务流程
3. 体现流程中所有的异常，以及异常是如何处理的

#### 流程图制作的注意事项

1. 流程图中，需要有开始和结束
2. 当出现判定时，需要使用棱形
3. 如果主流程图比较复杂，那其中涉及到的与主流程关系不大的子流程，可以用子流程图标代替
4. 流程图中不能出现交叉线
5. 要跟实际业务流程保持一致

#### 流程图制作软件

Axure 9, Visio, ProcessOn, 亿图图示

### 结构图

> 想象这样一个场景：老板把你叫到办公室，告诉你要做一个全新的产品，目前对于产品中需要具体做的功能都罗列好了，但是需要进行分类和规划，考虑产品有哪些大模块， 每个大模块中有哪些子模块和细节功能。请问该如何处理？
>
> 答案：制作产品结构图

#### 结构图的作用

- 很好地展示产品的整体结构，让项目组成员在项目初期，能够更好地从宏观上了解产品
- 是产品原型的简化表达，但比原型实现起来快很多
- 初期可以用来规划产品

#### 结构图的注意事项

- 根据产品的页面结构，从上到下，从左到右，依次制作
- 重点功能，重点制作
- 层级可以尽量深
...
- 通常来说，PRD可以包含的模块：需求、原型、流程图、结构图、交互说明、公司要求写的其他内容
- PRD的格式和写法，每个公司的要求可能不同，但都有一个统一的标准：传达清楚需求

### 头脑风暴

头脑风暴会议：

- 一堆人聚集在一起，针对某个主体，提出自己的看法，并进行讨论，得到最终结论。

此类会议出现的场景：

- 当需要多人讨论，而且需要有不同想法时，可以开头脑风暴会议。

#### 头脑风暴会议的注意事项

> 1. 可以是一堆产品经理一起来头脑风暴吗？或者一堆开发人员、一堆设计人员来开？
>
> 2. 大家如果讨论得时候跑偏了怎么办？
>
>    ​
...
1. 开会时间：上班前、下班前、时间短、效率高
2. 开会内容：上班前汇报目前的工作进度、遇到的问题、今天的工作计划；下班前汇报今天的工作完成情况、遇到的问题、明天的工作安排
3. 开会形式：多数为站会。

### 需求评审会

> 我们作为产品经理，在实施一个项目时，怎么将项目相关的需求内容传达给其他同事？如何确保传达的内容都能够被吸收理解？
>
> 答案：开需求评审会

1. 开会时间：项目初期，产品经理产出原型前后
2. 参与人员：项目组成员，不一定包括需求方
3. 会议内容：项目内容讲解，项目方案的可行性讨论，项目实施环节所需时间的安排和讨论
4. 注意事项：
   - 提前跟项目组成员约时间，并发正式邮件通知会议时间
   - 提前将会议中涉及到的文档发送给参会人员，让他们带着问题参会，提高效率
   - 开会中被怼很正常，需要有一颗强大的内心
